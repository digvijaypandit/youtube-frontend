...
const UploadVideo = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        // Define accessToken using localStorage
        const accessToken = localStorage.getItem('accessToken');  // ✅ Fix: Define accessToken
    ...
    return (
        <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center py-10">
            <div className="w-full max-w-2xl bg-gray-800 rounded-lg p-6 shadow-md">
                <h2 className="text-2xl font-bold mb-4">Upload Videos</h2>
                <div
                    className="border-2 border-dashed border-gray-600 rounded-lg p-6 mb-4 flex flex-col items-center justify-center cursor-pointer"
                ...
                <form onSubmit={handleSubmit}>
                    ...
                    <input
                        ...
                        name="thumbnail"
                        accept="image/*"
                        onChange={handleChange}  // ✅ Fix: Use handleChange instead of setThumbnail
                        className="w-full p-2 mb-4 border rounded bg-gray-700 text-white"
                    />
